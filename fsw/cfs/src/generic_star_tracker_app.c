...
**
** Purpose:
**   This file contains the source code for the GENERIC_STAR_TRACKER
*application.
**
*******************************************************************************/
  ...
  while (CFE_ES_RunLoop(&GENERIC_STAR_TRACKER_AppData.RunStatus) == true) {
    ...
    */
    status = CFE_SB_ReceiveBuffer(
        (CFE_SB_Buffer_t **)&GENERIC_STAR_TRACKER_AppData.MsgPtr,
    ...
    */
    if (status == CFE_SUCCESS) {
      ...
      CFE_EVS_SendEvent(
          GENERIC_STAR_TRACKER_PIPE_ERR_EID, CFE_EVS_EventType_ERROR,
...
int32 GENERIC_STAR_TRACKER_AppInit(void) {
  ...
  */
  ...
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "GENERIC_STAR_TRACKER: Error registering for event services: 0x%08X\n",
        (unsigned int)status);
    return status;
  }
  ...
  */
  status =
      CFE_SB_CreatePipe(&GENERIC_STAR_TRACKER_AppData.CmdPipe,
                        GENERIC_STAR_TRACKER_PIPE_DEPTH, "GENERIC_ST_CMD_PIPE");
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_PIPE_ERR_EID,
  ...
  */
  status = CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_STAR_TRACKER_CMD_MID),
                            GENERIC_STAR_TRACKER_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_SUB_CMD_ERR_EID,
                      CFE_EVS_EventType_ERROR,
  ...
  */
  status =
      CFE_SB_Subscribe(CFE_SB_ValueToMsgId(GENERIC_STAR_TRACKER_REQ_HK_MID),
                       GENERIC_STAR_TRACKER_AppData.CmdPipe);
  if (status != CFE_SUCCESS) {
    CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_SUB_REQ_HK_ERR_EID,
                      CFE_EVS_EventType_ERROR,
  ...
  ** telemetry that has been defined in the GENERIC_STAR_TRACKER_HkTelemetryPkt
  *for this app.
  */
  CFE_MSG_Init(
      CFE_MSG_PTR(GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.TlmHeader),
  ...
  *block
  */
  GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceEnabled =
  ...
  status = CFE_EVS_SendEvent(
      GENERIC_STAR_TRACKER_STARTUP_INF_EID, CFE_EVS_EventType_INFORMATION,
  ...
  if (status != CFE_SUCCESS) {
    CFE_ES_WriteToSysLog(
        "GENERIC_STAR_TRACKER: Error sending initialization event: 0x%08X\n",
        (unsigned int)status);
  }
  return status;
}
...
void GENERIC_STAR_TRACKER_ProcessCommandPacket(void) {
  ...
  /*
  ** Ground Commands with command codes fall under the
  *GENERIC_STAR_TRACKER_CMD_MID (Message ID)
  */
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(
        GENERIC_STAR_TRACKER_PROCESS_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
        "GENERIC_STAR_TRACKER: Invalid command packet, MID = 0x%x",
...
void GENERIC_STAR_TRACKER_ProcessGroundCommand(void) {
  ...
  */
  case GENERIC_STAR_TRACKER_NOOP_CC:
    ...
    */
    if (GENERIC_STAR_TRACKER_VerifyCmdLength(
            GENERIC_STAR_TRACKER_AppData.MsgPtr,
            sizeof(GENERIC_STAR_TRACKER_NoArgs_cmd_t)) == OS_SUCCESS) {
      /* Second, send EVS event on successful receipt ground commands*/
      CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_CMD_NOOP_INF_EID,
  ...
  */
  case GENERIC_STAR_TRACKER_RESET_COUNTERS_CC:
    if (GENERIC_STAR_TRACKER_VerifyCmdLength(
            ...
            sizeof(GENERIC_STAR_TRACKER_NoArgs_cmd_t)) == OS_SUCCESS) {
      CFE_EVS_SendEvent(
          GENERIC_STAR_TRACKER_CMD_RESET_INF_EID, CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_STAR_TRACKER_ENABLE_CC:
    if (GENERIC_STAR_TRACKER_VerifyCmdLength(
            GENERIC_STAR_TRACKER_AppData.MsgPtr,
            sizeof(GENERIC_STAR_TRACKER_NoArgs_cmd_t)) == OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_CMD_ENABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  case GENERIC_STAR_TRACKER_DISABLE_CC:
    if (GENERIC_STAR_TRACKER_VerifyCmdLength(
            GENERIC_STAR_TRACKER_AppData.MsgPtr,
            sizeof(GENERIC_STAR_TRACKER_NoArgs_cmd_t)) == OS_SUCCESS) {
      CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_CMD_DISABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
  ...
  */
  default:
    ...
    CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_CMD_ERR_EID, CFE_EVS_EventType_ERROR,
                      "GENERIC_STAR_TRACKER: Invalid command code for packet, "
                      "MID = 0x%x, cmdCode = 0x%x",
...
void GENERIC_STAR_TRACKER_ProcessTelemetryRequest(void) {
  ...
  */
  default:
    /* Increment the error counter upon receipt of an invalid command */
    GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.CommandErrorCount++;
    CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_DEVICE_TLM_ERR_EID,
                      CFE_EVS_EventType_ERROR,
                      "GENERIC_STAR_TRACKER: Invalid command code for packet, "
                      "MID = 0x%x, cmdCode = 0x%x",
                      CFE_SB_MsgIdToValue(MsgId), CommandCode);
...
void GENERIC_STAR_TRACKER_ReportHousekeeping(void) {
  ...
  if (GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceEnabled ==
      GENERIC_STAR_TRACKER_DEVICE_ENABLED) {
    status = GENERIC_STAR_TRACKER_RequestHK(
        &GENERIC_STAR_TRACKER_AppData.Generic_star_trackerUart,
        (GENERIC_STAR_TRACKER_Device_HK_tlm_t *)&GENERIC_STAR_TRACKER_AppData
            .HkTelemetryPkt.DeviceHK);
    if (status == OS_SUCCESS) {
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceCount++;
    } else {
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceErrorCount++;
      CFE_EVS_SendEvent(
          GENERIC_STAR_TRACKER_REQ_HK_ERR_EID, CFE_EVS_EventType_ERROR,
  ...
  CFE_SB_TimeStampMsg(
      (CFE_MSG_Message_t *)&GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt);
  CFE_SB_TransmitMsg(
      (CFE_MSG_Message_t *)&GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt, true);
  return;
}
...
void GENERIC_STAR_TRACKER_ReportDeviceTelemetry(void) {
  ...
  if (GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceEnabled ==
    ...
    status = GENERIC_STAR_TRACKER_RequestData(
        &GENERIC_STAR_TRACKER_AppData.Generic_star_trackerUart,
        (GENERIC_STAR_TRACKER_Device_Data_tlm_t *)&GENERIC_STAR_TRACKER_AppData
            .DevicePkt.Generic_star_tracker);
    if (status == OS_SUCCESS) {
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceCount++;
      /* Time stamp and publish data telemetry */
      CFE_SB_TimeStampMsg(
          (CFE_MSG_Message_t *)&GENERIC_STAR_TRACKER_AppData.DevicePkt);
      CFE_SB_TransmitMsg(
          (CFE_MSG_Message_t *)&GENERIC_STAR_TRACKER_AppData.DevicePkt, true);
    } else {
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceErrorCount++;
      CFE_EVS_SendEvent(
          GENERIC_STAR_TRACKER_REQ_DATA_ERR_EID, CFE_EVS_EventType_ERROR,
          "GENERIC_STAR_TRACKER: Request device data reported error %d",
          status);
    }
  }
  /* Intentionally do not report errors if disabled */
...
void GENERIC_STAR_TRACKER_Enable(void) {
  ...
  if (GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceEnabled ==
    ...
    *available
    */
    GENERIC_STAR_TRACKER_AppData.Generic_star_trackerUart.deviceString =
        GENERIC_STAR_TRACKER_CFG_STRING;
    GENERIC_STAR_TRACKER_AppData.Generic_star_trackerUart.handle =
        GENERIC_STAR_TRACKER_CFG_HANDLE;
    GENERIC_STAR_TRACKER_AppData.Generic_star_trackerUart.isOpen = PORT_CLOSED;
    GENERIC_STAR_TRACKER_AppData.Generic_star_trackerUart.baud =
        GENERIC_STAR_TRACKER_CFG_BAUDRATE_HZ;
    GENERIC_STAR_TRACKER_AppData.Generic_star_trackerUart.access_option =
        uart_access_flag_RDWR;

    /* Open device specific protocols */
    status =
        uart_init_port(&GENERIC_STAR_TRACKER_AppData.Generic_star_trackerUart);
    if (status == OS_SUCCESS) {
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceCount++;
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceEnabled =
          GENERIC_STAR_TRACKER_DEVICE_ENABLED;
      CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_ENABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "GENERIC_STAR_TRACKER: Device enabled");
    } else {
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceErrorCount++;
      CFE_EVS_SendEvent(
          GENERIC_STAR_TRACKER_UART_INIT_ERR_EID, CFE_EVS_EventType_ERROR,
          "GENERIC_STAR_TRACKER: UART port initialization error %d", status);
    }
  } else {
    GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceErrorCount++;
    CFE_EVS_SendEvent(
        GENERIC_STAR_TRACKER_ENABLE_ERR_EID, CFE_EVS_EventType_ERROR,
...
void GENERIC_STAR_TRACKER_Disable(void) {
  ...
  if (GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceEnabled ==
    ...
    /* Open device specific protocols */
    status =
        uart_close_port(&GENERIC_STAR_TRACKER_AppData.Generic_star_trackerUart);
    if (status == OS_SUCCESS) {
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceCount++;
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceEnabled =
          GENERIC_STAR_TRACKER_DEVICE_DISABLED;
      CFE_EVS_SendEvent(GENERIC_STAR_TRACKER_DISABLE_INF_EID,
                        CFE_EVS_EventType_INFORMATION,
                        "GENERIC_STAR_TRACKER: Device disabled");
    } else {
      GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceErrorCount++;
      CFE_EVS_SendEvent(
          GENERIC_STAR_TRACKER_UART_CLOSE_ERR_EID, CFE_EVS_EventType_ERROR,
          "GENERIC_STAR_TRACKER: UART port close error %d", status);
    }
  } else {
    GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.DeviceErrorCount++;
    CFE_EVS_SendEvent(
        GENERIC_STAR_TRACKER_DISABLE_ERR_EID, CFE_EVS_EventType_ERROR,
...
*/
int32 GENERIC_STAR_TRACKER_VerifyCmdLength(CFE_MSG_Message_t *msg,
  ...
  if (expected_length == actual_length) {
    ...
    CFE_EVS_SendEvent(
        GENERIC_STAR_TRACKER_LEN_ERR_EID, CFE_EVS_EventType_ERROR,
