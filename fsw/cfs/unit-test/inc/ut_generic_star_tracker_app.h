 ...
 *
 * Purpose:
 * Extra scaffolding functions for the generic_star_tracker_app unit test
 *
 * Notes:
...
#ifndef UT_GENERIC_STAR_TRACKER_APP_H
#define UT_GENERIC_STAR_TRACKER_APP_H

/*
 * Necessary to include these here to get the definition of the
 * "GENERIC_STAR_TRACKER_APP_Data_t" typedef.
 */
