...
** This struct is defined in the `generic_star_tracker_app.h` file with one
*global instance
** in the `.c` file.
*/
typedef struct {
  ...
  */
  GENERIC_STAR_TRACKER_Hk_tlm_t
      HkTelemetryPkt; /* GENERIC_STAR_TRACKER Housekeeping Telemetry Packet */
...
*/
extern GENERIC_STAR_TRACKER_AppData_t
    GENERIC_STAR_TRACKER_AppData; /* GENERIC_STAR_TRACKER App Data */
