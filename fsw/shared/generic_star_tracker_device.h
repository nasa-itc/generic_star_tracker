...
#define GENERIC_STAR_TRACKER_DEVICE_HK_LNGTH                                   \
  sizeof(GENERIC_STAR_TRACKER_Device_HK_tlm_t)
#define GENERIC_STAR_TRACKER_DEVICE_HK_SIZE                                    \
  GENERIC_STAR_TRACKER_DEVICE_HK_LNGTH + GENERIC_STAR_TRACKER_DEVICE_HDR_TRL_LEN
...
//#define GENERIC_STAR_TRACKER_DEVICE_DATA_LNGTH sizeof (
//GENERIC_STAR_TRACKER_Device_Data_tlm_t ) #define
//GENERIC_STAR_TRACKER_DEVICE_DATA_SIZE GENERIC_STAR_TRACKER_DEVICE_DATA_LNGTH +
//GENERIC_STAR_TRACKER_DEVICE_HDR_TRL_LEN
#define GENERIC_STAR_TRACKER_DEVICE_DATA_SIZE                                  \
  13 // 2 header, 2*4 uint16_t quaternion, 1 valid, 2 trailer
...
int32_t GENERIC_STAR_TRACKER_ReadData(uart_info_t *device, uint8_t *read_data,
                                      uint8_t data_length);
int32_t GENERIC_STAR_TRACKER_CommandDevice(uart_info_t *device, uint8_t cmd,
                                           uint32_t payload);
int32_t
