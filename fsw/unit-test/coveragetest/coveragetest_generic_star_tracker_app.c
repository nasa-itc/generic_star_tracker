...
void Test_GENERIC_STAR_TRACKER_AppMain(void) {
   ...
   */
  UtAssert_True(GENERIC_STAR_TRACKER_AppData.RunStatus ==
                    CFE_ES_RunStatus_APP_ERROR,
                "GENERIC_STAR_TRACKER_AppData.RunStatus (%lu) == "
                "CFE_ES_RunStatus_APP_ERROR",
  ...
  UT_CheckEvent_Setup(&EventTest, GENERIC_STAR_TRACKER_PIPE_ERR_EID,
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_STAR_TRACKER_PIPE_ERR_EID generated (%u)",
...
void Test_GENERIC_STAR_TRACKER_AppInit(void) {
  ...
  UT_SetDeferredRetcode(UT_KEY(CFE_EVS_Register), 1, CFE_EVS_INVALID_PARAMETER);
  UT_TEST_FUNCTION_RC(GENERIC_STAR_TRACKER_AppInit(),
...
void Test_GENERIC_STAR_TRACKER_ProcessCommandPacket(void) {
  ...
  UT_CheckEvent_Setup(&EventTest, GENERIC_STAR_TRACKER_PROCESS_CMD_ERR_EID,
                      NULL);
  ...
  UtAssert_True(EventTest.MatchCount == 0,
                "GENERIC_STAR_TRACKER_CMD_ERR_EID not generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  GENERIC_STAR_TRACKER_ProcessCommandPacket();
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_STAR_TRACKER_CMD_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
...
void Test_GENERIC_STAR_TRACKER_ProcessGroundCommand(void) {
  ...
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_STAR_TRACKER_CMD_NOOP_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
  ...
  GENERIC_STAR_TRACKER_ProcessGroundCommand();
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_STAR_TRACKER_CMD_RESET_INF_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
...
void Test_GENERIC_STAR_TRACKER_ReportHousekeeping(void) {
  ...
  /* Set message id to return so GENERIC_STAR_TRACKER_Housekeeping will be
   * called */
  UT_SetDataBuffer(UT_KEY(CFE_MSG_GetMsgId), &MsgId, sizeof(MsgId), false);
  ...
  UtAssert_True(MsgSend ==
                    &GENERIC_STAR_TRACKER_AppData.HkTelemetryPkt.TlmHeader.Msg,
...
void Test_GENERIC_STAR_TRACKER_VerifyCmdLength(void) {
   ...
   */
  UtAssert_True(EventTest.MatchCount == 0,
                "GENERIC_STAR_TRACKER_LEN_ERR_EID NOT generated (%u)",
                (unsigned int)EventTest.MatchCount);
   ...
   */
  UtAssert_True(EventTest.MatchCount == 1,
                "GENERIC_STAR_TRACKER_LEN_ERR_EID generated (%u)",
                (unsigned int)EventTest.MatchCount);
}
 ...
 */
void Generic_star_tracker_UT_Setup(void) { UT_ResetState(0); }
